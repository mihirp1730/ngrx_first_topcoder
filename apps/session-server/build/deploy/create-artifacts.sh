...
export IN_DIR="$BUILD_REPOSITORY_LOCALPATH/apps/session-server/build/deploy"
export OUT_DIR="$BUILD_REPOSITORY_LOCALPATH/buildartifacts/session-server"
mkdir -p $OUT_DIR
...
then
    ...
    docker build -f $BUILD_REPOSITORY_LOCALPATH/apps/session-server/build/dist.Dockerfile -t $DOCKER_IMAGE .
