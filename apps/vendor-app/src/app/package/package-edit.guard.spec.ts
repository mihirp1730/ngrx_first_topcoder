...
import { mockMatDialogModal, mockLeaveForm } from '../shared/services.mock';
import { ConfirmModalComponent } from '../confirm-modal/confirm-modal.component';


describe('PackageEditGuard', () => {
  let guard: PackageEditGuard;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(PackageEditGuard);
  });
  ...
  describe('Confirm with user if they would like to leave', () => {
    ...
    it('Should deactivate after user confirmation', (done) => {
      ...
      subscription.add(
        (guard.canDeactivate(mockLeaveForm) as Observable<boolean>)
          .subscribe((confirmed) => {
