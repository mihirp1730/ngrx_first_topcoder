...
export const createChat = createAction(
  '[Communication] Create Chat',
  props<{ topic: string; participants: Array<{ emailId: string; displayName: string }> }>()
);
...
export const openChat = createAction('[Communication] Open Chat', props<{ chatId: string }>());

export const openChatSuccess = createAction(
  '[Communication] Open Chat Success',
  props<{ chatId: string; messages: Array<IChatThreadMessage> }>()
);
