...
export IN_DIR="$BUILD_REPOSITORY_LOCALPATH/apps/content-server/build/deploy"
export OUT_DIR="$BUILD_REPOSITORY_LOCALPATH/buildartifacts/content-server"
mkdir -p $OUT_DIR
...
then
    ...
    docker build -f $BUILD_REPOSITORY_LOCALPATH/apps/content-server/build/dist.Dockerfile -t $DOCKER_IMAGE .
