...
export IN_DIR="$BUILD_REPOSITORY_LOCALPATH/apps/storage-server/build/deploy"
export OUT_DIR="$BUILD_REPOSITORY_LOCALPATH/buildartifacts/storage-server"
mkdir -p $OUT_DIR
...
then
    ...
    docker build -f $BUILD_REPOSITORY_LOCALPATH/apps/storage-server/build/dist.Dockerfile -t $DOCKER_IMAGE .
