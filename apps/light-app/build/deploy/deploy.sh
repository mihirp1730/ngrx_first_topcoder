...
# Add deployment environment to configmap-environments
...
envsubst < $SCRIPT_DIR/configmap-environments.yaml > $SCRIPT_DIR/configmap-environments.tmp
mv $SCRIPT_DIR/configmap-environments.tmp $SCRIPT_DIR/configmap-environments.yaml
